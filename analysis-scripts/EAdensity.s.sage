...
f=open("/home/mazur/worldline/EAs.F1l2p3.dat", 'r')
...
f=open("/home/mazur/worldline/EAs.F1l2p2.dat", 'r')
...
plt.clf()
p1=plt.errorbar(xcm1,I1,eI1,marker='.', color='k', ms=8, linewidth=0.0, elinewidth=1)
p2=plt.errorbar(xcm2,I2,eI2,marker='.', color='b', ms=8, linewidth=0.0, elinewidth=1)
...
ax.set_xlim(0.0,0.8)
plt.savefig('EAdensity.s.eps')
plt.savefig('EAdensity.s.png')
